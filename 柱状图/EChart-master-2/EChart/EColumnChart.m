...
- (void)reloadData
{
    ...
    [UIView animateWithDuration:0.8 delay:0 options:UIViewAnimationOptionCurveEaseIn animations:^
     {
         ...
         bottomLine.layer.cornerRadius = 0.0;
    ...
    [UIView animateWithDuration:0.8 delay:0 options:UIViewAnimationOptionCurveEaseIn animations:^
     {
         UIView *bottomLine = [[UIView alloc] initWithFrame:CGRectMake(0, self.frame.size.height, 2, BOTTOM_LINE_HEIGHT)];
         bottomLine.backgroundColor =[UIColor redColor];
         bottomLine.layer.cornerRadius = 0.0;
         [self addSubview:bottomLine];
         [bottomLine setFrame:CGRectMake(0, -4, 2, self.frame.size.height+5)];
